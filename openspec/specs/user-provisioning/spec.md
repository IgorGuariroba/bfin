...
Provisiona automaticamente usuários no banco no primeiro acesso via OIDC, mantendo a tabela `usuarios` com claims extraídas do token e garantindo unicidade por `id_provedor` e `email`.
