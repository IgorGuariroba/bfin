# emergency-reserve-goal Specification

## Purpose

Define a capability de meta de reserva de emergência: tabela de configuração por conta, endpoint UPSERT para definir a porcentagem de reserva, validação de intervalo, e invalidação síncrona de projeções após alteração de meta.
