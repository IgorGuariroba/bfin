# account-authorization Specification

## Purpose

Define o modelo de autorização por conta financeira (papéis `owner` e `viewer` em `conta_usuarios`) e o guard global de administrador (`is_admin`) aplicado a recursos do sistema. Fornece middlewares Fastify reutilizáveis para proteger rotas com base no papel do usuário autenticado em uma conta e para restringir rotas administrativas.
