...
Intercepta globalmente requests para rotas protegidas, valida Bearer Tokens, injeta dados do usuário autenticado em `request.user` e expõe a rota `GET /me` para consulta de perfil.
