/**
 * Color palette mapping CSS tokens to Chakra UI
 * Primary Brand: Purple (Nubank-inspired)
 * References CSS variables defined in index.css
 */

export const colors = {
  // Brand color (Purple) - Primary palette
  brand: {
    50: 'rgb(var(--clr-purple-50))',
    100: 'rgb(var(--clr-purple-100))',
    200: 'rgb(var(--clr-purple-200))',
    300: 'rgb(var(--clr-purple-300))',
    400: 'rgb(var(--clr-purple-400))',
    500: 'rgb(var(--clr-purple-500))',
    600: 'rgb(var(--clr-purple-600))',
    700: 'rgb(var(--clr-purple-700))',
    800: 'rgb(var(--clr-purple-800))',
    900: 'rgb(var(--clr-purple-900))',
  },

  // Purple palette (alias for brand)
  purple: {
    50: 'rgb(var(--clr-purple-50))',
    100: 'rgb(var(--clr-purple-100))',
    200: 'rgb(var(--clr-purple-200))',
  ...
  // Red palette (Error/Danger states)
  red: {
